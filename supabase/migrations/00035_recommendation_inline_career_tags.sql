-- =============================================================================
-- Migration 00035: Inline career entries and availability tags in RPCs (P2)
-- =============================================================================
-- Adds current_company, current_title, and availability_tags directly to
-- get_recommended_alumni and get_popular_alumni return types via LEFT JOIN LATERAL.
-- Eliminates 2 follow-up queries per RPC call in the application layer.

-- Drop and recreate get_recommended_alumni with career + tags
...
AS $$
  ...
  FROM scored s
  LEFT JOIN LATERAL (
    SELECT company, job_title FROM career_entries
...
-- Drop and recreate get_popular_alumni with career + tags
